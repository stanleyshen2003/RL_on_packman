...
public:
	...
	virtual float update(const board& b, float u) {
		// TODO
		// input u is the update value. I divide u into amount of wieghts that need
...
public:
	...
	void saverec(const std::string& path) {
		...
		if (outputFile.is_open()) {
			...
			for (const double& element : record) {
				outputFile << element << ",";
			}
